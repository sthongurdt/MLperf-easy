...
export MODEL_DIR=~/mlperf/models/onnx
export DATA_DIR=~/mlperf/data/fake_imagenet/

# Ejecutar pruebas
./run_and_time.sh onnxruntime resnet50 cpu --accuracy
sleep 120
./run_and_time.sh onnxruntime resnet50 cpu --scenario SingleStream
sleep 120
./run_and_time.sh onnxruntime resnet50 cpu --scenario MultiStream
sleep 120
